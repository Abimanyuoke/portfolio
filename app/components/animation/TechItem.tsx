...
export default function TechItem({ title, ImgTech }: TechItemProps) {
    return (
        <div className="bg-dark-200 dark:bg-black flex justify-center lg:w-[250px] py-4 items-center border-2 border-surface-50 dark:border-white rounded-[8px] mx-1">
